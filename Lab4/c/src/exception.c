...
/*
 * Handle the inherited EL0 SVC demo.
 *
...
/* Report FIQ exceptions until Lab4 adds a real FIQ handler. */
static void handle_fiq_exception(exception_origin_t origin);

/* Report SError exceptions until Lab4 adds a real SError handler. */
